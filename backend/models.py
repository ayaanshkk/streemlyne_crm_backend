...
class RoleMaster(db.Model):
    ...
    # Relationships
    role_permission_mappings = db.relationship('RolePermissionMapping', back_populates='role', lazy='dynamic', cascade='all, delete-orphan')
...
class CustomerAuth(db.Model):
    ...
    def generate_jwt_token(self, secret_key: str) -> str:
        ...
        return generate_customer_token(customer_user_id=self.customer_user_id, client_id=self.client_id, tenant_id=self.tenant_id, secret_key=secret_key)
...
def is_module_available(module_name: str) -> bool:
    ...
    Args: module_name: 'education' | 'interior_design' | 'legacy'
    Returns: bool
    """
    return {
